            ...
            <div className="min-h-screen fintech-bg flex flex-col relative">
                ...
                <main className="p-6 max-w-md mx-auto w-full z-10 flex flex-col items-center">
                    ...
                    <div className="relative mb-16 group cursor-pointer animate-robot-intro z-30 flex justify-center">
                        ...
                        <div className="absolute left-[110%] top-1/2 -translate-y-1/2 w-max max-w-[150px] glass-card px-4 py-2 text-[10px] font-black text-secondary text-center shadow-xl animate-bounce-in z-40 border-2 border-white/50">
                            Choose your payment method.
                            <div className="absolute top-1/2 -left-2 -translate-y-1/2 w-3 h-3 bg-white/80 border-b-2 border-l-2 border-white/40 rotate-45 transform"></div>
                        </div>
